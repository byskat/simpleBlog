<template>
  <div>
      ...
      <div class="container mx-auto flex items-center">
        ...
        <div class="flex pl-4 text-sm">
          <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
            <li class="mr-2">
              <nuxt-link class="inline-block py-2 px-2 text-white no-underline" to="/">HOME</nuxt-link>
            </li>
            <li class="mr-2">
              <nuxt-link
    ...
    <div
      id="header"
      class="bg-white fixed w-full z-10 top-0 animated fadeOutUp hidden"
      style="opacity: .95;"
    >
      <div class="bg-white">
      ...
      <div
        ...
        style="background: linear-gradient(to right, #4dc0b5 var(--scroll), transparent 0); --scroll:1.44605%;"
      ></div>
    </div>
  </div>
</template>
